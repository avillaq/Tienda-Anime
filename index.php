    ...
    <main>
        <div class="servicios">
            <div class="gratis">
                ...
                <h3>Envío gratis</h3>
                <P>El envío de todos nuestros productos es totalmente gratuito, sin ningún coste adicional.</P> 
            </div>
            <div class="originales">
                <i class="fa-solid fa-award"></i>
                <h3>Productos originales</h3>
                <P>Todos nuestros productos son originales y cuentan con estándares de gran calidad.</P> 
            </div>
            <div class="dias">
